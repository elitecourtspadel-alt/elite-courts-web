...
const menuSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Mocha Iced Latte", price: "Rs 350", image: image: "/images/sports/iced-mocha-latte.jpg", fallback: "https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800" },
