...
export default function PadelTournamentAdmin() {
  ...
  const semi1Teams = [data.knockouts?.qf1?.winner, data.knockouts?.qf3?.winner].filter(Boolean) as string[];
  const semi2Teams = [data.knockouts?.qf2?.winner, data.knockouts?.qf4?.winner].filter(Boolean) as string[];
