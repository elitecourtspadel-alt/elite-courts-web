...
// YOUR CHOICE: Set a custom default placeholder image path here (can be a local public asset like '/images/choice-placeholder.png')
const DEFAULT_CHOICE_IMAGE = "https://i.ibb.co/example/your-default-image.png"; 
...
export default function ProductPage() {
  ...
  // If the product doesn't have an image path in Firebase, it falls back to your choice image definition
  const displayImage = cleanImageUrl(rawImage) || DEFAULT_CHOICE_IMAGE;
